...
* [HashMap](#hashmap)
    ...
    * [2. HashMap 高级特性](#2-hashmap-高级特性)
      ...
      * [2.2 HashMap的容量为什么一定是2的n次方](#22-hashmap的容量为什么一定是2的n次方)
      * [2.3 负载因子为什么是0.75](#22-负载因子为什么是0.75)  
      * [2.4 线程安全问题](#2-线程安全问题)
        * [2.4.1 线程不安全的表现](#241-线程不安全的表现)
        * [2.4.2 源码分析](#242-源码分析)
          * [2.4.2.1 新增节点顺序](#2421-新增节点顺序)
          * [2.4.2.2 JDK1.7死环现象分析](#2422-jdk1.7死环现象分析)
          * [2.4.2.3 JDK1.8扩容过程分析](#2423-jdk1.8扩容过程分析)
      * [2.5 树的特性](#24-树的特性)
<!-- GFM-TOC -->
...
```
  ...
  扩容之后元素的位置要么在原来位置上,要么在原位置再移动2^n的位置上;
```
 - **解释过程**
 ```
...
##### 2.4.2.3 JDK1.8扩容过程分析
``` 
  JDK 1.8扩容时保持链表顺序不变,避免了死环现象的发生;
```
### 2.5 树的特性
#### 2.5.1 红黑树的引入
 - 可以直接查看我的 [AlgorithmAlgorithm-And-DataStructure](https://github.com/553899811/Algorithm-And-DataStructure)专题中进行树结构的学习。
